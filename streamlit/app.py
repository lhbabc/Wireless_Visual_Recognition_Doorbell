...
biden_image = face_recognition.load_image_file("face_recognition/examples/bhodia.jpg")
biden_face_encoding = face_recognition.face_encodings(biden_image)[0]

# Create arrays of known face encodings and their names
known_face_encodings = [obama_face_encoding, biden_face_encoding]
known_face_names = ["Barack Obama", "Bhodia"]
        ...
        for face_encoding in face_encodings:
            ...
            if matches[best_match_index]:
                ...
                if name in known_face_names:
                    st.success(str(name) + " is at the door!")
                    time.sleep(5)
